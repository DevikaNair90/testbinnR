...
summary_captures_ %>% rbind(prox_5_combined_summary_row, prox_20_combined_summary_row)
...
final_res %>% select(Set, Proximity, Method, c(12:19)) %>% rbind(prox_5_combined_res, prox_20_combined_res)
